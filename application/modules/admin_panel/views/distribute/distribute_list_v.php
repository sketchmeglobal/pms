...
<head>
    ...
    <title>Distribute List | <?=WEBSITE_NAME;?></title>
...
<section>
    ...
    <div class="body-content" style="min-height: 700px;">
        ...
        <div class="page-head">
            ...
            <h3 class="m-b-less">Distribute</h3>
                ...
                <div class="col-lg-12">
                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="<?= base_url('admin/add-distribute') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add Distribute</a>



                            <table id="distribution_table" class="table data-table dataTable">

                                <thead>

                                    <tr>

                                        <th>Distribute Number</th>
    ...
    $(document).ready(function() {
        ...
        $('#distribution_table').DataTable( {
            ...
            "ajax": {
                ...
                "url": "<?=base_url('admin/ajax_distribute_table_data')?>",
