...
<section>
    ...
    <div class="body-content" style="min-height: 1500px;">
        ...
        <!-- page head start-->
        <div class="page-head">
            <h3 class="m-b-less">Wastage Report</h3>
            <div class="state-information">
                <ol class="breadcrumb m-b-less bg-less">
                    <li><a href="<?=base_url('admin/dashboard');?>">Home</a></li>
                    <li class="active"> Wastage Report</li>
                </ol>
            </div>
        </div>
        <!-- page head end-->
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-lg-3">
                                      ...
                                      <select id="po_id" name="po_id" class="select2 form-control">
                                        ...
                                        <option value="<?=$pos->po_id?>"><?=$pos->po_number?></option>
                                        <?php } ?>
                                      </select>
                                    </div>
                                    ...
                                    <div class="col-lg-3">
                                      ...
                                      <select id="pod_id" name="pod_id[]" class="select2 form-control" multiple required>
                                        <option value="">Select CN Number</option>
                                        <?php 
                                        if(isset($purchase_order_detail)) {
                                        foreach($purchase_order_detail as $pods){ ?>
                                        <option value="<?=$pods->pod_id?>"><?=$pods->consignement_number?></option>
                                        <?php }} ?>
                                      </select>
                                    </div>
